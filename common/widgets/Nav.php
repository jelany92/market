 ...
 * This version of the Nav widget has been modified to allow opening dropdown nav-items simply by hovering over them.
 * 'nav-custom-widget.css' is necessary for this to function properly
 *
 * For example:
 *
 * ```php
...
class Nav extends Widget
{
     ...
     */
    public $dropdownClass = 'common\widgets\Dropdown';
