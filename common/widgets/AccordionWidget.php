...
class AccordionWidget extends Widget
{
     ...
     * label - the string header of item
    ...
    public function run()
    {
        ...
        foreach ($this->items as $key => $item)
        {
            ...
            {
                $itemOptions['id'] = isset($item['id']) ? $item['id'] : $this->options['id'] . '-' . $key;
            }
            $itemOptions = ArrayHelper::merge($itemOptions, [
            ...
            echo Html::a(Html::tag('h4', $item['label'], [
                'class' => 'panel-label',
            ]), '#' . $itemOptions['id'], [
                             'class'         => 'panel-heading',
            ...
            echo Html::tag('div', Html::tag('div', $item['content'], ['class' => 'panel-body']), $itemOptions);
