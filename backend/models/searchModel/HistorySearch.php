...
class HistorySearch extends History
{
    ...
    {
        return [
            [['id', 'company_id', 'current_admin_user_id'], 'integer'],
            [['summary', 'note', 'edited_date_at', 'created_at', 'updated_at'], 'safe'],
        ];
    }
    ...
    {
        $query = History::find()->andWhere(['company_id' => \Yii::$app->user->identity->id]);
        ...
        $query->andFilterWhere([
                                   ...
                                   'edited_date_at'        => $this->edited_date_at,
