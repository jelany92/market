    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><?= 'No Sidebar'; ?></li>
                <li class="breadcrumb-item"><?= 'Boxed'; ?></li>
            </ol>
        </div><!-- End .container -->
        ...
        <div class="container">
            ...
            <div class="products">
                        ...
                        <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                            <div class="product">
                                <figure class="product-media">
                                    ...
                                    <?php if (isset($article->article_photo)) : ?>
                                        <?= Html::a(Html::img(ArticleInfo::articleImagePath($article->article_photo), [
                                            'option' => [
                                                'alt'   => 'Product image',
                                                'class' => 'product-image',
                                            ],
                                ...
                                <div class="product-body">
                                    <?= Html::a($article->category->category_name, [''], [
                                        'options' => [
                                            'class' => 'product-cat',
                                        ],
                                    ]) ?>
                                    <h3 class="product-title">
                                        <?= Html::a($article->article_name_ar, [''], [
                                            'options' => [
                                                'class' => 'product-cat',
                                            ],
                                        ]) ?>
                                    ...
                                    <div class="product-price">
                                        <?php if (isset($article->article_buy_price)) : ?>
                                            <?= Html::label($article->article_buy_price, [''], [
                                                'options' => [
                                                    'class' => 'product-cat',
                                                ],
                                            ]) ?>
                ...
                <div class="load-more-container text-center">
                    <?= Html::a(Yii::t('app', 'More Products') . Icon::show('sync', ['style' => 'margin-left: 10px;']), '#', ['class' => 'btn btn-outline-darker btn-load-more']) ?>
